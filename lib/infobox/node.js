  ...
  function showClients(d) {
    ...
    return function (el) {
      ...
      for (var clientsNum in clientTypes) {
        ...
        span.textContent = "\uF345 ".repeat(clients.count) // ion-md-person
      ...
      spanmesh.textContent = "\uF345 ".repeat(meshclients - totalClients) // ion-md-person
